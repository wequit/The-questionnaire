...
interface Questions_Six_Twelve_Props {
  questions: Question[];
}

export default function Questions_Six_Twelve({
  questions,
}: Questions_Six_Twelve_Props) {
            ...
            >
              <div className="mb-6">
                ...
                <div className="flex items-center justify-center Gap px-16 mt-4">
                  {question.options.slice(1, question.options.length - 1).map((option, index, filteredOptions) => {
