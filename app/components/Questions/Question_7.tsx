...
export default function Question_Seven({ questions }: Question_Seven_Props) {
  ...
  // Добавлена адаптивная логика для размеров кнопок
  ...
  // Функция для определения фона кнопок
  ...
  return (
    <section
      ...
      className="p-10 Padding" // Стиль с отступами
              ...
              return (
                ...
                >
                  ...
                  <div
                    ...
                    style={getSizeStyle(index, filteredOptions.length)} // Применение динамического размера
                  >
                    {!isSelected && (
