...
export default function Question_Five({
  ...
  const [selectedOption, setSelectedOption] = useState<string | null>(() => {
    const storedOption = localStorage.getItem("Question_5");
  ...
  const handleNext = () => {
    ...
    localStorage.setItem("Question_5", JSON.stringify(selectedOption));
    onNext();
  };
  ...
  return (
    <div className="p-6">
      ...
      {["Ооба", "Жок", "Жарым-жартылай", "Жооп берүү кыйын", ].map((option, index) => (
