...
export default function Question_Fourteen({ questions }: Question_Fourteen_Props) {
  ...
  return (
    <section  id={`question-${question.id}`} className="p-10 Padding" data-question-answered={selectedOption ? "true" : "false"}>
      <div className="mb-6">
        <h2 className="text-[1.100rem] font-bold font-inter text-gray-900 mb-4 ContainerQuestionEX">{questionText}</h2>
        ...
        <div className="flex items-center justify-center Gap px-16 mt-4">
          {" "}
          {/* Добавляем отступы для корректного размещения */}
          {question.options
